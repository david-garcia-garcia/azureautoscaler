...
namespace poolautoscaler.tests
{
    public class ResourceProcessorTests
    {
        ...
        [Fact]
        public async Task ProcessOneAsync_WhenScalingConfigurationsNull_StillRefreshesAndLogsNoConfigurationsInformation()
        {
            var config = CreateResourceConfiguration(Array.Empty<ScalingConfiguration>());
        ...
        [Fact]
        public async Task ProcessOneAsync_WhenDisabledWithinHour_SkipsRefreshAndDoesNotLogEvaluationError()
        {
            var config = CreateResourceConfiguration(Array.Empty<ScalingConfiguration>());
            var resourceLoggerMock = new Mock<ILogger>();
            var state = new TestResourceState("test://test", resourceLoggerMock.Object, config)
            ...
            state.DisabledUntil[ResourceState.UnhandledExceptionPrefix + "simulated evaluation failure"] =
                DateTime.UtcNow.Add(ResourceState.UnhandledExceptionDisableDuration);
